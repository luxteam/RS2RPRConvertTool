...
def convertRedshiftPhysicalLight(rs_light):
	...
	if lightType == 0: #area
		...
		setProperty(rprLightShape, "areaLightShape", area_shape[getProperty(rs_light, "areaShape")])
